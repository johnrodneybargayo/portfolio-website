      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10 py-12 md:py-20">
        <div ref={textRef} className="space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-4">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 border-2 border-blue-500 text-blue-400 hover:bg-blue-500/10 font-bold py-2 md:py-3 px-6 md:px-8 rounded-lg transition duration-300 text-sm md:text-base"
            >
              Get in Touch
            </Link>
          </div>
